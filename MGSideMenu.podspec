Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Mustafa GUNES"
  # s.authors            = { "Mustafa GUNES" => "gunes149@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Mustafa GUNES"
  ...
  s.source       = { :git => "http://EXAMPLE/MGSideMenu.podspec.git", :tag => "#{s.version}" }
